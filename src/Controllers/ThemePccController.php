...
namespace Kho8k\ThemePcc\Controllers;
...
class ThemePccController
{
    public function index(Request $request)
    {
        ...
        return view('themes::themepcc.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themepcc.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themepcc.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
