            ...
            <div class="list-servers">
                <div class="block-heading">
                    ...
                    <div class="movie-description">
                        <p id="movie-content-short">{{ Str::limit($currentMovie->content, 150) }}</p>
                        <p id="movie-content-full" style="display: none;">{{ $currentMovie->content }}</p>
                        <button id="toggle-content" class="btn btn-info">Xem Thêm</button>
                    </div>
                </div>
                <div class="episodes-wrapper-outer">
                    @foreach ($currentMovie->episodes->sortBy([['server', 'asc']])->groupBy('server') as $server => $data)
                        <div class="server-episodes-wrapper">
                            <div class="server-name">
                                <i class="sp-movie-icon-camera"></i> {{ $server }}
                            </div>
                            <div class="list-episodes">
                                <div class="episodes mCustomScrollbar _mCS_{{ $loop->index }} mCS_no_scrollbar">
                                    <div id="mCSB_{{ $loop->index }}" class="mCustomScrollBox mCS-light-thin mCSB_vertical mCSB_inside">
                                        <div id="mCSB_{{ $loop->index }}_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y">
...
{{--                </div>--}}
                <div id="hidden-download">
                    <div class="block mt-xl">
                        <h3 class="block-title weight-normal">
                            <i class="sp-movie-icon-user-review"></i><span class="text_dv">Phim liên quan</span>
                        </h3>
                        <div class="block-content pt">
